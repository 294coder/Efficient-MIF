...
class VSR_CAS(torch.nn.Module):
    ...
    def __init__(self, channel0 ,factor, P=None, patch_size=None):
        ...
        self.conv_downsample = torch.nn.Conv2d(in_channels=31, out_channels=31, kernel_size=7, stride=8, padding=7 // 2)
        self.conv_upsample   = torch.nn.ConvTranspose2d(in_channels=31, out_channels=31, kernel_size=7,stride=8, padding=7 // 2 )
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        flops = FlopCountAnalysis(net, (LR, RGB))
