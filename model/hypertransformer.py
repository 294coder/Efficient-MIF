...
class HyperTransformer(BaseModel):
    ...
    # @get_local('T_lv1', 'T_lv2', 'T_lv3', 'x11', 'x22', 'x33')
    def _forward_implem(self, X_MS, X_PAN):
        ...
        # tmp code
        # feats = [T_lv1, T_lv2, T_lv3, x11, x22, x33]
        torch.save(T_lv1.to(dtype=torch.float16), 'visualized_img/hypertransformer_feats/feat_T_lv1.pt')
        torch.save(T_lv2.to(dtype=torch.float16), 'visualized_img/hypertransformer_feats/feat_T_lv2.pt')
        torch.save(T_lv3.to(dtype=torch.float16), 'visualized_img/hypertransformer_feats/feat_T_lv3.pt')
        torch.save(x11_up.to(dtype=torch.float16), 'visualized_img/hypertransformer_feats/feat_x11.pt')
        torch.save(x22_up.to(dtype=torch.float16), 'visualized_img/hypertransformer_feats/feat_x22.pt')
        torch.save(x33.to(dtype=torch.float16), 'visualized_img/hypertransformer_feats/feat_x33.pt')
        torch.save(x.to(dtype=torch.float16), 'visualized_img/hypertransformer_feats/feat_x.pt')
